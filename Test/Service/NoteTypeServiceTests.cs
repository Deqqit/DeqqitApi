...
public class NoteTypeServiceTests(NoteTypeServiceFixture fixture) : IntegrationTestBase<NoteTypeServiceFixture>(fixture)
{
    ...
    {
        // Seed
        Context.NoteTypes.Add(new NoteType
            { CreatorId = Fixture.TestCreatorId, Name = "Existing", Templates = [], CssStyle = "" });
    ...
    {
        NoteType nt = new() { CreatorId = Fixture.TestCreatorId, Name = "To Delete", Templates = [], CssStyle = "" };
